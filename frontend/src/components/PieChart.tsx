...
const CategoriesPieChart: React.FC<CategoriesPieChartProps> = ({
  ...
  const fetchExpenseData = async () => {
    try {
      ...
      if (activeFilter === "Today") {
        ...
        data = await expenseService.getAllExpenses(); // Temporary: fetch all and filter client-side
      ...
      const processedData = processExpenseData(data || []);
  ...
  const processExpenseData = (expenses: any[]): ChartData[] => {
